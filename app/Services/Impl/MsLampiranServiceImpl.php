...
class MsLampiranServiceImpl implements MsLampiranService
{
    /**
     * @param $id
     * @return array
    ...
    public function validateData($req): array
    {
        ...
        try {
            if (gettype($req) == "array") {
                ...
                if (empty($req['lampiran_kode']) || empty($req['lampiran_nama'])) {
                    $res = [
                        'status' => false,
    ...
    public function add(array $data): array
    {
        ...
        try {
            $dt = MsLampiran::create($data);
            if (!isset($dt->lampiran_id)) {
                $res = [
                    'status' => false,
                    'msg' => 'Data gagal ditambahkan. Silahkan hubungi Admin!',
                ];
            }
            $res["id"] = $dt->lampiran_id;
        } catch (\Throwable $th) {
            $res = [
                'status' => false,
                'msg' => $th->getMessage(),
