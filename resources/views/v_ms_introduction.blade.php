        ...
        <div class="row" id="rowForm" style="display:none;">
          <div class="col-12">
            <form id="formVendor">
              ...
              <input type="hidden" id="mi_id" name="mi_id">
              <div class="row form-group">
                <label class="col-md-3 control-label">Kode</label>
                <div class="col-md-2">
                  <input type="text" class="form-control" id="mi_kode" name="mi_kode" maxlength="2">
                </div>
                <input type="hidden" id="old_mi_kode">
              </div>
              <div class="row form-group">
                <label class="col-md-3 control-label">Nama</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" id="mi_nama" name="mi_nama">
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-3 control-label">Isi</label>
                <div class="col-md-5">
                  <textarea class="form-control" id="mi_isi" name="mi_isi"></textarea>
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-3 control-label">Status</label>
                <div class="col-md-2">
                  <select name="mi_status" id="mi_status" class="form-control">
...
<script>
  // init component
  // global
  const baseDir = baseUrl + '/ms-pengenalan',
    rowForm = $("#rowForm"),
    rowData = $("#rowData");
          ...
          mi_kode: {
            ...
            remote: {
              ...
              data: {
                ...
                old: function() {
                  return act.val() == 'edit' ? oldMiKode.val() : "";
                }
              }
            },
          },
    ...
    $.ajax({
      ...
      success: function(res) {
        if (res.status) {
          ...
          act.val('edit');
          miId.val(id);
          miKode.val(dt.mi_kode);
          oldMiKode.val(dt.mi_kode);
          miNama.val(dt.mi_nama);
          miIsi.val(dt.mi_isi);
          miIsi.summernote("code", decodeURIComponent(dt.mi_isi));
          miStatus.val(dt.mi_status);
